...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='network/routes.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/simpleMap_ql/weib_200kcars'

    env = SumoEnvironment(net_file='network/simpleMap.net.xml',
