...
class TrafficSignal:
    ...
    def __init__(self, env, ts_id, delta_time, yellow_time, min_green, max_green):
        ...
        self._waiting_times = {} #Added from Andrea vidali
    ...
    #Reward function from Andrea Vidali
    def _andrea_reward(self):
    ...
    #Added from Andrea Vidali. Uses Andrea's approach to collecting waiting times
